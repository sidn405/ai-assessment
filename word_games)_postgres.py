# word_games_postgres.py - PostgreSQL version
...
async def get_game_vocabulary(user_id: int = Depends(get_current_user_id)):
    """
...
async def complete_game(
    ...
    try:
        ...
        new_badges = check_and_award_game_badges(user_id, cursor, conn)
...
@router.get("/stats")
async def get_game_stats(user_id: int = Depends(get_current_user_id)):
    """
...
def check_and_award_game_badges(user_id: int, cursor, conn) -> List[str]:
    """
